...
#subprocess.call('utils/scale_embed.py {} {}'.format(query, doc), shell=True)
...
subprocess.call('cp {}/*.pkl ./'.format(std_dir), shell=True)
subprocess.call('rm -f {}/*.pkl'.format(std_dir), shell=True)
subprocess.call('rm -f {}/*.pkl.scaled'.format(std_dir), shell=True)
