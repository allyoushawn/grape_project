...
feat_loc=/home/allyoushawn/features/journal/seq2seq_ssae_ali_lambda_10
mkdir -p $feat_loc
...
for target in test train query.dev ; do
    ...
    scripts/gen_tfrecords_with_ali.py feat_scp/$target.39.cmvn.scp $feat_loc/$target.tfrecords material/$target.ali
