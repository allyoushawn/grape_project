...
cat $dir/phones/align_lexicon.txt | utils/kaldi_sym2int.pl -f 3- $dir/phones.txt | \
  utils/kaldi_sym2int.pl -f 1-2 $dir/words.txt > $dir/phones/align_lexicon.int
...
cat $dir/oov.txt | utils/kaldi_sym2int.pl $dir/words.txt >$dir/oov.int || exit 1;
...
utils/kaldi_sym2int.pl $dir/phones.txt <$dir/phones/wdisambig.txt >$dir/phones/wdisambig_phones.int
utils/kaldi_sym2int.pl $dir/words.txt <$dir/phones/wdisambig.txt >$dir/phones/wdisambig_words.int
...
for f in silence nonsilence optional_silence disambig context_indep; do
  utils/kaldi_sym2int.pl $dir/phones.txt <$dir/phones/$f.txt >$dir/phones/$f.int
  utils/kaldi_sym2int.pl $dir/phones.txt <$dir/phones/$f.txt | \
   awk '{printf(":%d", $1);} END{printf "\n"}' | sed s/:// > $dir/phones/$f.csl || exit 1;
done

for x in sets extra_questions; do
  utils/kaldi_sym2int.pl $dir/phones.txt <$dir/phones/$x.txt > $dir/phones/$x.int || exit 1;
done

utils/kaldi_sym2int.pl -f 3- $dir/phones.txt <$dir/phones/roots.txt \
   > $dir/phones/roots.int || exit 1;

if [ -f $dir/phones/word_boundary.txt ]; then
  utils/kaldi_sym2int.pl -f 1 $dir/phones.txt <$dir/phones/word_boundary.txt \
